...
This is an Android Application Development course exercises repository "template".
...
exercise repository back to JAMK GitLab (to create own repository) with his/her own account and complete each exercise 
inside this repository.

When you are creating a new repository using this template, 
REMEMBER USE <b>android-exercises</b> as a repository name, otherwise evaluation tool can't find your repository!

Student need to add teacher to repository member for an evaluation purposes. Teacher need at least a Reporter role.
...
<b>Teacher</b> will move an issue to the <b>Closed</b> section in a Issues Boards when exercise is approved. 
...
Student needs to <b>add a comment</b> to issues section when student moves issue/exercise to <b>In Review</b> in Issues Board. 
...
Don't include video files to your repository - those take a too much space!

### Repository structure example
Below is an example repository structure. Example contains two projects: FirstApplication and BuildUIWithLayoutEditor.
Both project has screenshots. All other files are related to created Android Studio project.
...
... | ...
BuildUIWithLayoutEditor | BuildUIWithLayoutEditor project folder
BuildUIWithLayoutEditor/Screenshots/image01.png | Screenshot of the project
... | ...
